...
const ACHIEVEMENTS = [].concat(
  ...
  achSeries('gym', 'exSeen', [1,5,10,20,30,EXERCISES.length],
    ['Первое упражнение','Разминка','Десять техник','Знаток зала','Тренерский взгляд','Вся база упражнений'],
    function(g){ return g === EXERCISES.length ? 'Изучи технику всех ' + g + ' упражнений сайта' : 'Изучи технику ' + g + ' ' + plural(g,'упражнения','упражнений','упражнений'); }),
